...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"js/main/menuItem.js":[function(require,module,exports) {
"use strict";
...
var MenuItem = /*#__PURE__*/function () {
  function MenuItem(el) {
    ...
    var _this$DOM$textsGroupE = this.DOM.textsGroupEl.querySelectorAll('text');

    var _this$DOM$textsGroupE2 = _slicedToArray(_this$DOM$textsGroupE, 2);

    this.DOM.text_1 = _this$DOM$textsGroupE2[0];
    this.DOM.text_2 = _this$DOM$textsGroupE2[1];
  ...
  _createClass(MenuItem, [{
    ...
    value: function initEvents() {
      ...
      this.onMouseEnterFn = function () {
        _this.DOM.textsGroupEl.style.filter = "url(#".concat(_this.filterId, ")");
    ...
    value: function createTimeline() {
      ...
      this.tl = _gsap.gsap.timeline({
        ...
        onComplete: function onComplete() {
          _this2.DOM.textsGroupEl.style.filter = 'none';
        },
        onReverseComplete: function onReverseComplete() {
          _this2.DOM.textsGroupEl.style.filter = 'none';
        },
        onUpdate: function onUpdate() {
          _this2.DOM.feBlur.setAttribute('stdDeviation', _this2.primitiveValues.stdDeviation);
        }
...
},{"gsap":"../node_modules/gsap/index.js"}],"js/main/menu.js":[function(require,module,exports) {
"use strict";
...
var Menu = function Menu(el) {
  ...
  _toConsumableArray(this.DOM.el.querySelectorAll('.menu__item')).forEach(function (item) {
    return _this.items.push(new _menuItem.default(item));
  });
};

exports.default = Menu;
},{"./menuItem":"js/main/menuItem.js"}],"js/utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getPageYScroll = exports.getMousePos = exports.calcWinsize = exports.lerp = exports.map = exports.preloadFonts = void 0;
...
},{}],"js/main/index.js":[function(require,module,exports) {
"use strict";
...
var menu = new _menu.default(document.querySelector('nav.menu')); //CURSOR
...
var initCanvas = function initCanvas() {
  ...
  var noiseRange = 5; // range of distortion
  ...
  paper.view.onFrame = function (event) {
    ...
    if (!isStuck) {
      ...
      lastX = lerp(lastX, clientX, 0.25);
      lastY = lerp(lastY, clientY, 0.25);
      group.position = new paper.Point(lastX, lastY);
      polygon.fillColor = null;
    } else if (isStuck) {
      // fixed position on a nav item
      lastX = lerp(lastX, stuckX, 0.25);
      lastY = lerp(lastY, stuckY, 0.25);
      group.position = new paper.Point(lastX, lastY);
...
var initHovers = function initHovers() {
  ...
  var linkItems = document.querySelectorAll(".menu__item");
...
initHovers();
},{"./menu":"js/main/menu.js","../utils":"js/utils.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","js/main/index.js"], null)
//# sourceMappingURL=/main.541533be.js.map